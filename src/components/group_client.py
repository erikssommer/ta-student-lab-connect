...
class GroupClientComponent:
    def __init__(self):
        self.app = app.gui()
        self.tasks = ["Task 1: Implement a linked list. Duration: 30min", "Task 2: Implement a stack. Duration: 30min", "Task 3: Implement a queue. Duration: 30min", "Task 4: Implement a binary search tree. Duration: 30min", "Task 5: Implement a hash table. Duration: 30min"]
    ...
    def setup_gui(self):
        ...
        self.app.addLabel("upper_right_label_date", f"Date: {datetime.now().strftime('%d/%m/%Y')}")
        ...
        self.app.addLabel("title", "Welcome to the lab").config(font="Helvetica 25")
        self.app.addLabel("subtitle", "Tasks for this lab session:").config(font="Helvetica 15")
        ...
        self.app.addLabel("description_label", "Need help? - Ask TAs for help!")
    ...
    def show_message(self):
        self.app.infoBox(title="Instructions", message="Use the checkboxes to mark the tasks you have completed. When you are ready to request help, enter a description of the help you need in the text field below and click the 'Request Help' button. The TAs will then come to your group and help you with your tasks. Good luck!")
